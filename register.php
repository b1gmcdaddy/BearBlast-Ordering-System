...
<body>
    ...
    if (isset($_POST['reg_button'])) {
        ...
        $sql = "INSERT INTO users (email, first_name, last_name, phone_number, password, usertype) VALUES ('$email', '$firstname', '$lastname', '$phonenumber', '$hashed_password', '$usertype')";
        if ($conn->query($sql) === TRUE) {
            ...
            <div class="card-body">
              <p class="card-text">Your account has been</br>succesfully created!</p>
            </div>
            </div>
            </div>';
        } else {
